...
const Navbar = () => {
  ...
  return (
    ...
    <div className= {`fixed w-[100%]  px-8 py-1 ${
      scrolling ? 'bg-white' : 'bg-transparent'
        ...
        <div className="flex-1">
          <ul className="flex  justify-between cursor-pointer  mr-7 p-3 text-white font-medium text-sm">
            <li className={`border-b-2 border-gray-800 ${scrolling ? "text-black" :""}`}>HOME</li>
            <li   onMouseEnter={toggleDropdown}
      onMouseLeave={toggleDropdown}
             className={`hover:border-b-2 hover:border-gray-800 flex  ${scrolling ? "text-black" :""}`}>
              INDUSTRIES 
        ...
        <div className="absolute top-12 rounded-md left-97 p-5 mt-1 bg-white border border-gray-300 shadow-lg">
          {/* Your list of industries goes here */}
          <ul className="py-2 text-black">
            ...
            <li className={`hover:border-b-2 hover:border-gray-800 ${scrolling ? "text-black" :""}`} >
              AI SOFTWARE
            </li>
            <li className={`hover:border-b-2 hover:border-gray-800 ${scrolling ? "text-black" :""}`}>BLOG</li>
            <li className={`hover:border-b-2 hover:border-gray-800 ${scrolling ? "text-black" :""}`}>
              CONTACT US
            </li>
          </ul>
