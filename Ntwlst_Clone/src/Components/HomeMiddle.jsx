const HomeMiddle = () => {
  return (
    <div className="">
      <div className=" flex justify-center content-center mt-12     w-[100%] h-auto   ">
        <div className="flex items-center justify-between w-[100%] px-7  ">
          <div className="   flex-1">
            <h1 className="font-semibold text-[45px] text-[#FF3A2D] tracking-wider">
              Mine-To-Mill-To-Mine{" "}
            </h1>
            <h1 className="font-semibold text-[45px] text-[#FF3A2D] tracking-wider">
              Optimization
            </h1>
            <p className="text-[18px] pt-4  tracking-wide font-medium text-[#474747]">
          ...
          <div className=" flex justify-end pl-7 items-center  flex-1">
            <img
              className="w-[120%]"
      ...
      <div className=" flex justify-center content-center mt-12     w-[100%] h-auto   ">
        <div className="flex items-center justify-between w-[100%] px-7  ">
          <div className=" flex justify-end pr-7 items-center  flex-1">
            <img
              className="w-[120%]"
      ...
      {/* 5rd */}
      <div className=" flex justify-center content-center mt-12 mb-12     w-[100%] h-auto   ">
        <div className="flex items-center justify-between w-[100%] px-7  ">
          <div className=" flex justify-end pr-7 items-center  flex-1">
            <img
              className="w-[120%]"
