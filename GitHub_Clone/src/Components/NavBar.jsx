  ...
  return (
    <div className="border border-b-slate-600 flex justify-between items-center py-3 px-4 bg-[#010409] text-white">
      <div className=" flex items-center gap-4">
        ...
        {/* <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Github-circle_%28CoreUI_Icons_v1.0.0%29.svg/2048px-Github-circle_%28CoreUI_Icons_v1.0.0%29.svg.png" alt="" /> */}
